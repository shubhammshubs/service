...
class MyOtp2 extends StatefulWidget {
  ...
  const MyOtp2({Key? key, required this.mobileNumber});
  @override
  State<MyOtp2> createState() => _MyOtpState();
}

class _MyOtpState extends State<MyOtp2> {
                ...
                child: ElevatedButton(onPressed: () async {
                  ...
                  try{
                    ...
                    PhoneAuthCredential credential = PhoneAuthProvider.credential(
                        verificationId: ForgotPassMobVerify.verify,
                        smsCode: code);
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) =>
                          ForgetPass(mobileNumber: widget.mobileNumber,
                          ),),
                    );
              ...
              Row(
                children: [
                  TextButton(onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => ForgotPassMobVerify(),),
                    );
                  },
